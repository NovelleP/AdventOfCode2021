...
def calc_flashes_afet_N_steps(energy_levels: list[list[int]]) -> int:
    target_flashes = len(energy_levels) * len(energy_levels[0])
    step = 1
    while True:
...
if __name__ == '__main__':
    ...
    ans = calc_flashes_afet_N_steps(energy_levels)
    print(ans)
